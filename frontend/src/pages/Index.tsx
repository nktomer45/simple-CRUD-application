...
const Index = () => {
  ...
  const latestUsers = [...users].sort((a, b) => parseInt(b.id || "0") - parseInt(a.id || "0")).slice(0, 10);
      ...
      <div className="container mx-auto py-12 px-4">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 mb-6">
            Welcome to the MicroUserVerse - Manage your users with ease
          </p>
          <Button size="lg" onClick={() => navigate("/users")}>
            Go to Users
          </Button>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Current number of users in the system</CardDescription>
            </CardHeader>
            <CardContent>
              ...
              {isLoading ? (
                ...
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">{latestUsers[0].email}</p>
                  </div>
                </div>
              ) : (
          ...
          <Card>
            ...
            <CardContent className="flex flex-col gap-2">
              <Button variant="outline" onClick={() => navigate("/users/new")} className="justify-start">
                Add New User
              </Button>
              <Button variant="outline" onClick={() => navigate("/users")} className="justify-start">
                View All Users
              </Button>
            </CardContent>
          </Card>
        ...
        <Card className="mb-6">
          <CardHeader>
            ...
            <CardDescription>Most recently added users in the system</CardDescription>
          </CardHeader>
          <CardContent>
            {isLoading ? (
              ...
              <div className="text-center py-6">
                ...
                <Button variant="outline" onClick={() => navigate("/users/new")} className="mt-4">
                  Add Your First User
                </Button>
              </div>
            )}
